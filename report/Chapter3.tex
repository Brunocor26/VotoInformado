...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/screenshot_dev_options.jpg}
    \caption{Interface de Opções de Desenvolvedor.}
    \label{fig:dev_options}
\end{figure}

Esta funcionalidade é acedida através de um botão flutuante (FAB) no ecrã principal e permite:
\begin{itemize}
