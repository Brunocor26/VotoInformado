...
A utilização do \textit{Android Profiler} permitiu identificar e corrigir fugas de memória, especialmente no carregamento de imagens, confirmando a eficácia da introdução da biblioteca Picasso.
